...
**Live demo:** https://order-tracking-screen.vercel.app
...
| ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| **On track** (baseline)               | “Arriving tomorrow” with a delivery window and the last scan location                                                                                                                                                                                                       | [/orders/SW-40211](https://order-tracking-screen.vercel.app/orders/SW-40211)                   |
| **Delayed: running late** (1–2 days)  | Amber. The original date is struck through, the new estimate and the carrier’s reason are shown. Offers a “notify me of changes” toggle and a support shortcut.                                                                                                             | [/orders/SW-39870](https://order-tracking-screen.vercel.app/orders/SW-39870)                   |
| **Delayed: significantly** (≥ 3 days) | Red. Shows “5 days late” with an apology. Offers **Request refund or cancel** (with a confirmation step and outcome), or keep waiting with alerts on.                                                                                                                       | [/orders/SW-39215](https://order-tracking-screen.vercel.app/orders/SW-39215)                   |
| **Delivered but not received**        | Shows proof of delivery (the rider’s photo, where it was left, a masked address) and **I didn’t receive it**. That opens a 3-step flow: quick checks, a short report, then a case reference. The screen then shows **Investigation open**, and this persists on the device. | [/orders/SW-40107](https://order-tracking-screen.vercel.app/orders/SW-40107)                   |
| **Tracking not available yet**        | “Preparing your order”. Explains why there are no scans yet and what happens next, keeps the estimated delivery window and the full timeline, and offers “notify me when tracking is live”. Never an empty screen.                                                          | [/orders/SW-40290](https://order-tracking-screen.vercel.app/orders/SW-40290)                   |
| **Delivered** (baseline)              | Proof of delivery, with a low-key “Report a problem” link                                                                                                                                                                                                                   | [/orders/SW-38754](https://order-tracking-screen.vercel.app/orders/SW-38754)                   |
| Loading                               | Skeleton with the same layout, announced to screen readers                                                                                                                                                                                                                  | [?simulate=loading](https://order-tracking-screen.vercel.app/orders/SW-40211?simulate=loading) |
| Error                                 | Friendly error with **Try again** (which recovers) and support that still works                                                                                                                                                                                             | [?simulate=error](https://order-tracking-screen.vercel.app/orders/SW-40211?simulate=error)     |
| Not found                             | A real HTTP 404, with a way back                                                                                                                                                                                                                                            | [/orders/SW-00000](https://order-tracking-screen.vercel.app/orders/SW-00000)                   |
| Empty list                            | “No orders yet”                                                                                                                                                                                                                                                             | [/?simulate=empty](https://order-tracking-screen.vercel.app/?simulate=empty)                   |
...
| `npm test`                   | Vitest domain and component tests (65 tests)                                                                                                           |
...
**Status precedence** (the first match wins): delivered with an open case → _investigating_; delivered → _delivered_; ≥ 3 days late → _severely late_; late or overdue → _late_; no carrier scans → _preparing_; otherwise → _on track_.
...
- **Persistence is per device** (localStorage). Use **Demo → Reset demo data** to start over.
